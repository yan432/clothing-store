...
const UK_SHIPPING_SECTIONS = [
  ...
  },
  {
    ...
    body: 'Вартість доставки розраховується під час оформлення замовлення залежно від країни, ваги та доступного перевізника. Для замовлень від €120 доставка безкоштовна.',
  },
  {
...
const SHIPPING_COPY = {
  ...
  uk: {
    ...
    summary: [
      ...
      { Icon: Gift, label: 'Безкоштовно від €120', sub: 'Для всіх замовлень' },

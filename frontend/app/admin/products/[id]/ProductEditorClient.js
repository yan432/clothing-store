    ...
    async function load() {
      try {
        ...
        setForm({
          ...
          material_care_uk: p.material_care_uk || '',
          product_details: p.product_details || '',
          product_details_uk: p.product_details_uk || '',
          fit_info: p.fit_info || '',
          fit_info_uk: p.fit_info_uk || '',
          category: p.category || '',
          ...
          is_menswear: p.is_menswear !== false,
          is_womenswear: p.is_womenswear !== false,
        })
      } catch (e) {
      ...
      {loading ? (
          ...
          <form onSubmit={handleSubmit} style={{display:'flex',flexDirection:'column',gap:12,background:'#fff',border:'1px solid #ecece8',borderRadius:12,padding:16}}>
            ...
            <div style={{border:'1px solid #dbeafe',borderRadius:10,padding:14,background:'#eff6ff'}}>
              ...
              <p style={{fontSize:11,color:'#60a5fa',margin:'10px 0 0'}}>Якщо поле порожнє, українська сторінка тимчасово покаже англійський текст.</p>
            </div>

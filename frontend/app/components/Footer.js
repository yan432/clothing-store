    ...
    <footer style={{background:'#0a0a0a',color:'#fff',marginTop:80}}>
      <div style={{maxWidth:1200,margin:'0 auto',padding:'60px 24px 40px'}} className="footer-grid">
        ...
        <div className="footer-brand">
          ...
          <div style={{display:'flex',gap:10}}>
            <a href="https://www.instagram.com/edm.clothes" target="_blank" rel="noopener noreferrer"
              ...
              style={{width:36,height:36,borderRadius:'50%',border:'1px solid #555',display:'flex',alignItems:'center',justifyContent:'center',textDecoration:'none'}}>
        ...
        <div className="footer-shop">
          <p style={{fontSize:11,fontWeight:600,letterSpacing:'0.12em',color:'#aaa',textTransform:'uppercase',margin:'0 0 20px'}}>{d.footer.shop}</p>
        ...
        <div className="footer-care">
          <p style={{fontSize:11,fontWeight:600,letterSpacing:'0.12em',color:'#aaa',textTransform:'uppercase',margin:'0 0 20px'}}>{d.footer.customerCare}</p>
          <ul style={{listStyle:'none',margin:0,padding:0,display:'flex',flexDirection:'column',gap:12}}>
        ...
        <div className="footer-newsletter">
          <p style={{fontSize:11,fontWeight:600,letterSpacing:'0.12em',color:'#aaa',textTransform:'uppercase',margin:'0 0 20px'}}>{d.footer.newsletter}</p>
